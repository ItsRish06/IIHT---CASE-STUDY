@login
Feature: SimplyTravel Login Functionality

  Scenario: To validate the successfully Navigation to SimplyTravel Login page
    Given l-User enters SimplyTravel url
